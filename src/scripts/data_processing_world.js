...
// match names between database and maps
const mapNames = {
...
// translations
const en2zh = JSON.parse(fs.readFileSync('data/maps-translations/en2zh.json'))
const states_abbr_en = JSON.parse(fs.readFileSync('data/maps-translations/us_states_abbr_en.json'))
const states_abbr_zh = JSON.parse(fs.readFileSync('data/maps-translations/us_states_abbr_zh.json'))
...
const iso3166Codes = JSON.parse(fs.readFileSync('data/maps-translations/iso3166_codes.json'))
