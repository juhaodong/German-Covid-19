...
# download maps
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_CHN_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_CHN_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_HKG_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_HKG_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_MAC_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_MAC_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_TWN_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_TWN_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_KOR_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_KOR_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_ITA_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_ITA_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_FRA_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_FRA_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_DEU_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_DEU_shp.zip
wget -nc https://biogeo.ucdavis.edu/data/gadm3.6/shp/gadm36_JPN_shp.zip -P ./data/maps/
unzip -o -d ./data/maps/ ./data/maps/gadm36_JPN_shp.zip

wget -nc https://raw.githubusercontent.com/zcreativelabs/react-simple-maps/master/topojson-maps/world-50m-simplified.json -P ./data/maps/world-50m.json

wget -nc https://cdn.jsdelivr.net/npm/us-atlas@3/states-10m.json -P ./data/maps/states-10m.json
